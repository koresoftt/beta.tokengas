 ...
 * 2. Verifica la sesión.
 * 3. Muestra la página con diseño AdminLTE.
 */

// Para producción, se recomienda desactivar la visualización de errores:
...
// Para producción: asegúrate de que $apiBase apunte al endpoint correcto.
// Aquí se usa el endpoint beta; cámbialo si es necesario.
